...
const lessons: Lesson[] = [
  {
    title: "Ребёнок в мире взрослых театров",
    text: "В начале XX века маленьких детей обычно не водили в театр: считалось, что знакомиться со спектаклями можно примерно с десяти лет. Наталия родилась в семье театрального композитора Ильи Саца и певицы Анны Щастной. Но с театром она познакомилась гораздо раньше: уже в один год отец брал маленькую Наташу на репетиции.",
    fact: "Начало XX века — маленьких детей обычно не водили в театр; отец — композитор Илья Сац; мать — певица Анна Щастная; Наталия в театре с одного года.",
  },
  {
    title: "Игрушечный оркестр и первые уроки",
    text: "В детстве Наташа устроила игрушечный оркестр и сама стала его дирижёром. Она училась играть на фортепиано. Когда Наталии было девять лет, умер её отец. Девочка помогала семье: давала уроки фортепиано.",
    fact: "Игрушечный оркестр — Наташа-дирижёр; фортепиано; в девять лет Наталия начала помогать семье уроками музыки.",
  },
  {
    title: "Синяя птица и выбор пути",
    text: "Наталия смотрела спектакли Московского Художественного театра из-за кулис. Её любимым спектаклем была «Синяя птица», музыку к которой написал отец — Илья Сац. Позже Наталия занималась в театральной студии Софьи Халютиной и работала с Евгением Вахтанговым. Так она поняла, что хочет соединить в своей работе театр и музыку.",
    fact: "Московский Художественный театр — «Синяя птица» — Илья Сац; Софья Халютина — Евгений Вахтангов; выбор театра и музыки.",
  },
  {
    title: "1917 год: театр на колёсах",
    text: "После революции в Москве было много беспризорных детей. В 1917 году Наталии было пятнадцать лет. Моссовет выдал ей немного денег, лошадь и повозку, чтобы устраивать спектакли и концерты для детей в разных районах Москвы. За три года под её руководством состоялось 1823 детских спектакля и концерта. Перед представлениями Сац объясняла детям, что они увидят и как вести себя. Так появилась традиция вступительного слова.",
    fact: "1917 год — 15 лет — театр на колёсах — вступительное слово; за три года — 1823 спектакля и концерта.",
  },
  {
    title: "Октябрь 1918 года: Первый детский театр Моссовета",
    text: "В октябре 1918 года открылся Первый детский театр Моссовета. В нём были театр марионеток, театр теней и балаган театра петрушек. Сац продолжила выступать перед спектаклями со вступительным словом: рассказывала детям, что они увидят, и объясняла правила поведения в театре.",
    fact: "Октябрь 1918 года — Первый детский театр Моссовета; марионетки — театр теней — Петрушка; продолжение вступительных слов.",
  },
  {
    title: "1921 год: Московский театр для детей",
    text: "В 1921 году Наталия Сац создала Московский театр для детей. Новый театр пришлось создавать с нуля. За время работы Сац в нём поставили семнадцать спектаклей.",
    fact: "1921 год — Московский театр для детей — создание с нуля — семнадцать спектаклей.",
  },
  {
    title: "1931–1932 годы: Берлин и Буэнос-Айрес",
    text: "В 1931 году Наталия Сац стала первой в мире женщиной — оперным режиссёром. В двадцать восемь лет она поставила оперу Джузеппе Верди «Фальстаф» в Берлине. В следующем, 1932 году Сац поставила оперу Вольфганга Амадея Моцарта «Свадьба Фигаро» в Буэнос-Айресе.",
    fact: "1931 год — первая в мире женщина — оперный режиссёр — Берлин — «Фальстаф»; 1932 год — Буэнос-Айрес — «Свадьба Фигаро».",
  },
  {
    title: "1936 год: Центральный детский театр",
    text: "В 1936 году театр Наталии Сац получил новый дом на Театральной площади. На открытии показали «Золотой ключик» — пьесу, которую по просьбе Сац написал Алексей Толстой. В театре работали педагоги: они готовили детей к спектаклям и обсуждали их с юными зрителями. Позднее Сац задумала музыкальный «путеводитель» по оркестру, обратилась к Сергею Прокофьеву, и вместе они сочинили сюжет симфонической сказки «Петя и волк».",
    fact: "1936 год — Центральный детский театр — «Золотой ключик» — Алексей Толстой — театральные педагоги; Сергей Прокофьев — «Петя и волк».",
  },
  {
    title: "1937 год: театр помог выстоять",
    text: "В 1937 году Наталию Сац арестовали и отправили в лагерь. Даже там она продолжила заниматься театром: создала оркестр «Драмджаз», нашла музыкантов среди заключённых и ставила спектакли. Театр помогал ей выстоять, а другим людям — избежать тяжёлых работ на лесоповале.",
    fact: "1937 год — лагерь — оркестр «Драмджаз» — спектакли — помощь заключённым.",
  },
  {
  ...
  {
    title: "1958–1965 годы: снова Москва",
...
const miniTours: Question[][] = [
  [
    { title: "Кем были родители Наталии Сац?", options: ["Композитором и певицей", "Архитектором и художницей", "Учителем и врачом"], answer: 0 },
    { title: "В каком возрасте Наталия впервые оказалась в театре?", options: ["В один год", "В девять лет", "В пятнадцать лет"], answer: 0 },
    { title: "Кем Наташа была в своём игрушечном оркестре?", options: ["Дирижёром", "Балериной", "Художницей"], answer: 0 },
    ...
    { title: "Какой спектакль был любимым у Наташи?", options: ["«Синяя птица»", "«Морозко»", "«Золотой ключик»"], answer: 0 },
  ],
  [
    ...
    { title: "Какой театр Наталия Сац создала в 1921 году?", options: ["Московский театр для детей", "Первый детский театр Алма-Аты", "Детский музыкальный театр"], answer: 0 },
  ],
  [
    { title: "Какого достижения Наталия Сац добилась в 1931 году?", options: ["Стала первой в мире женщиной — оперным режиссёром", "Открыла первый детский театр Алма-Аты", "Добилась строительства Дворца музыки"], answer: 0 },
    { title: "Какой вариант правильно связывает события 1931 и 1932 годов?", options: ["1931 — Берлин, «Фальстаф»; 1932 — Буэнос-Айрес, «Свадьба Фигаро»", "1931 — Буэнос-Айрес, «Свадьба Фигаро»; 1932 — Берлин, «Фальстаф»", "1931 — Москва, «Морозко»; 1932 — Алма-Ата, «Чио-Чио-сан»"], answer: 0 },
    { title: "Какой спектакль открывал новый дом Центрального детского театра в 1936 году?", options: ["«Золотой ключик»", "«Морозко»", "«Синяя птица»"], answer: 0 },
    ...
    { title: "Как назывался оркестр, созданный Наталией Сац в лагере?", options: ["«Драмджаз»", "«Синяя птица»", "«Мосэстрада»"], answer: 0 },
  ],
  [
    ...
    { title: "Какая последовательность событий верна?", options: ["Театр в Алма-Ате (1945) — возвращение в Москву (1958) — Детский музыкальный театр (1965) — Дворец музыки (1979) — Наталия Сац ушла из жизни (1993)", "Возвращение в Москву (1958) — театр в Алма-Ате (1945) — Дворец музыки (1979) — Детский музыкальный театр (1965) — Наталия Сац ушла из жизни (1993)", "Дворец музыки (1979) — Детский музыкальный театр (1965) — театр в Алма-Ате (1945) — возвращение в Москву (1958) — Наталия Сац ушла из жизни (1993)"], answer: 0 },
  ],
];
...
const finalQuestions: Question[] = [
  { title: "Как зовут создателя театра для детей?", options: ["Наталия Ильинична Сац", "Вера Игнатьевна Мухина", "Анна Щастная"], answer: 0 },
...
const workshopData: WorkshopData = {
  ...
  crossword: [["Фамилия создателя театра для детей", "САЦ"], ["Опера, открывшая театр в 1965 году", "МОРОЗКО"], ["Для кого Наталия Сац создавала театры?", "ДЕТЕЙ"], ["Какого цвета птица — символ мечты и счастья?", "СИНЯЯ"]],
...
const importantPart = /^(Наталия Ильинична Сац|Наталия Сац|Илья Сац|Анна Щастная|Синяя птица|начале XX века|один год|девять лет|Софья Халютина|Евгений Вахтангов|1917 году|1823|вступительного слова|1918 года|1921 году|семнадцать|1931 году|1932 году|Джузеппе Верди|«Фальстаф»|Вольфганга Амадея Моцарта|«Свадьба Фигаро»|1936 году|Центральный детский театр|«Золотой ключик»|Алексей Толстой|Сергей Прокофьев|«Петя и волк»|1937 году|«Драмджаз»|«Чио-Чио-сан»|1945 года|1958 году|детский отдел Мосэстрады|21 ноября 1965 года|Московского театра эстрады|1979 году|1993 году|Первый детский театр Моссовета|Детский музыкальный театр)$/;
...
export default function SatsRoute({ onBack, onMatching, onNext }: { onBack: () => void; onMatching: () => void; onNext: () => void }) {
  ...
  const finalSet = useMemo(
    () => [...finalQuestions, ...finalMiniQuestions].sort(() => Math.random() - 0.5).slice(0, 10).map(mixQuestion),
    [testVersion],
  );
  ...
  return <main className="compact highrise-module route-start sats-module">
    ...
    {page === "plan" && <>
      ...
      <div className="part-list">
        {["Детство: театр и музыка", "Первые театры для детей", "Признание и испытания", "Возвращение и Дворец музыки"].map((title, index) => <button className="part-row" key={title} onClick={() => startPart(index)}><span><b>Часть {index + 1}. {title}</b><small>3 учебных экрана → 5 заданий</small></span><span>Открыть →</span></button>)}
    ...
    {page === "lesson" && <>
      ...
      <section className="spread">
        <aside><img src={`./assets/${lessonMedia[step][0]}`} alt={lessonMedia[step][1]} /><small>ИЛЛЮСТРАЦИЯ ИЗ КНИГИ МАРШРУТА</small><p><strong>{lessonMedia[step][1]}</strong></p><div className="part-tag">ЧАСТЬ {part + 1}<br /><b>{["Детство: театр и музыка", "Первые театры для детей", "Признание и испытания", "Возвращение и Дворец музыки"][part]}</b></div></aside>
