...
const oldFinalQuestions: Question[] = [
...
const oldWorkshopData: WorkshopData = {
  route: "Останкинская телебашня", image: "./assets/card-tower.png", imageAlt: "Первый искусственный спутник Земли",
...
const oldImportant = /(искусственные спутники Земли)/g;
const oldImportantPart = /^(искусственные спутники Земли)$/;

const oldLessonMedia = [
  ["card-tower.png", "Первый искусственный спутник Земли"],
  ["card-tower.png", "Первый искусственный спутник Земли"],
  ["card-tower.png", "Первый искусственный спутник Земли"],
  ["card-tower.png", "Первый искусственный спутник Земли"],
...
const lessons: Lesson[] = [
  {title:"Что такое Останкинская телебашня?",text:"Останкинская телебашня — уникальное сооружение высотой 540 метров. Её построили в 1967 году, когда телебашен такой высоты ещё не было. В том же году она вошла в Книгу рекордов Гиннесса как самое высокое сооружение на Земле. Башня принимает подготовленные телецентром электрические сигналы, усиливает их и передаёт зрителям.",fact:"1967 год; 540 метров; точная подпись изображения — «Телебашня»."},
  {title:"Как сигнал попадает в телевизор?",text:"Передачи создают в телецентре рядом с башней. Оттуда слабый электрический сигнал идёт по подземным проводам в зал телевизионных передатчиков. Для каждого телеканала работает свой передатчик: он усиливает сигнал. Затем сигнал поднимается по толстым кабелям — фидерам — к антеннам на вершине и оттуда направляется к телевизорам.",fact:"Телецентр → подземные провода → передатчик → фидеры → антенны → телевизоры."},
  {title:"Почему прежней башни стало недостаточно?",text:"До Останкинской телебашни телевидению служила металлическая Шуховская башня высотой 160 метров, спроектированная Владимиром Григорьевичем Шуховым. Москва росла, телевизоров становилось больше, а невысокая башня не могла передавать сигнал в отдалённые районы. Потребовалась новая, более высокая и мощная телебашня.",fact:"Владимир Григорьевич Шухов; Шуховская башня — 160 метров; Москве потребовалась более мощная башня."},
  {title:"Кто придумал и оформил башню?",text:"Инженер Николай Васильевич Никитин предложил построить башню из железобетона и отвечал за прочность конструкции. Архитектор Леонид Ильич Баталов совершенствовал её облик: придумал огромные окна, стеклянные обстройки этажей, смотровую площадку и ресторан. Инженер добивается надёжности, архитектор — выразительного и красивого облика.",fact:"Николай Васильевич Никитин — инженер и конструктор; Леонид Ильич Баталов — архитектор."},
  {title:"Зачем внутри стальные тросы?",text:"Бетон расширяется при нагревании и сжимается при охлаждении, поэтому без защиты в нём могли бы появиться трещины. Внутри полого ствола башни натянуты 145 стальных канатов. Они сжимают бетон по вертикали с общим натяжением около 10 000 тонн и защищают его от трещин при перепадах температуры.",fact:"145 стальных канатов; около 10 000 тонн натяжения; защита бетона от трещин."},
  {title:"Как строили башню?",text:"Для башни использовали сверхпрочный бетон, разработанный химиком Борисом Давидовичем Тринкером. Чтобы состав оставался одинаковым, воду, цемент, щебень и песок всё время брали из одних и тех же мест, а рядом работал бетонный завод. Обычных кранов нужной высоты не существовало, поэтому создали самоподъёмный агрегат. За неделю башня вырастала в среднем на 5–6 метров.",fact:"Борис Давидович Тринкер — сверхпрочный бетон; самоподъёмный агрегат; 5–6 метров в неделю."},
  {title:"Почему башня не падает?",text:"Фундамент башни заглублён всего чуть более чем на 4,5 метра, но сооружение весит 55 тысяч тонн. Нижняя часть примерно втрое тяжелее верхней, поэтому центр тяжести расположен низко. Башня ведёт себя как игрушка-неваляшка: после отклонения стремится вернуться в вертикальное положение. У неё десять ног-опор.",fact:"Фундамент — чуть более 4,5 метра; вес — 55 тысяч тонн; 10 опор; принцип неваляшки."},
  {title:"Качается ли Останкинская башня?",text:"Тяжёлый железобетонный ствол не раскачивается как травинка, но металлический шпиль с антеннами может отклоняться. Теоретически при сильном ветре вершина способна уйти в сторону на 12 метров. Во время урагана 1998 года шпиль отклонился на 6 метров, а затем вернулся в прежнее положение.",fact:"Теоретическое отклонение — 12 метров; ураган 1998 года — 6 метров."},
  {title:"Что находится высоко над Москвой?",text:"На высоте 337 метров расположены смотровая площадка и вращающийся ресторан: примерно за час его пол совершает полный оборот. Стеклянный пол площадки выдерживает до трёх тонн. Два пассажирских лифта движутся со скоростью 7 метров в секунду. При ветре сильнее 12 метров в секунду они замедляются вдвое, а при скорости более 20 метров в секунду останавливаются.",fact:"337 метров; оборот примерно за час; стекло — до 3 тонн; лифты — 7 метров в секунду."},
];

const miniTours: Question[][] = [
  [
    {title:"Когда построили Останкинскую телебашню?",options:["1967 год","1957 год","1975 год"],answer:0},
    {title:"Какова высота башни?",options:["160 метров","337 метров","540 метров"],answer:2},
    ...
    {title:"Как называлась прежняя московская телебашня?",options:["Шуховская","Спасская","Останкинская"],answer:0},
    {title:"Как нужно подписать изображение в олимпиадном задании?",options:["Антенна","Телецентр","Телебашня"],answer:2},
  ],
  [
    {title:"Кто был главным инженером и конструктором башни?",options:["Леонид Баталов","Николай Никитин","Борис Тринкер"],answer:1},
    {title:"Кто отвечал за архитектурный облик башни?",options:["Леонид Баталов","Владимир Шухов","Николай Никитин"],answer:0},
    {title:"Зачем внутри башни натянуты стальные канаты?",options:["Они сжимают бетон и защищают от трещин","Они передают телевизионный сигнал","По ним движутся лифты"],answer:0},
    {title:"Сколько стальных канатов указано в книге?",options:["10","145","540"],answer:1},
    {title:"Какое устройство пришлось создать для строительства?",options:["Вращающийся ресторан","Самоподъёмный агрегат","Шуховскую сетку"],answer:1},
  ],
  [
    ...
    {title:"Как отклонился шпиль во время урагана 1998 года?",options:["На 3 метра","На 6 метров","На 12 метров"],answer:1},
    {title:"На какой высоте находятся смотровая площадка и ресторан?",options:["160 метров","337 метров","540 метров"],answer:1},
    {title:"Что происходит с лифтами при ветре более 20 метров в секунду?",options:["Они ускоряются","Они останавливаются","Они движутся вдвое быстрее"],answer:1},
  ],
];
...
const finalQuestions: Question[] = [
  ...
  {title:"Какой материал предложил Николай Никитин?",options:["Дерево","Железобетон","Стекло"],answer:1},
  {title:"Что называют фидерами?",options:["Толстые кабели для передачи сигнала вверх","Стальные канаты, сжимающие бетон","Ноги-опоры башни"],answer:0},
  {title:"Какова масса башни?",options:["10 тысяч тонн","55 тысяч тонн","145 тысяч тонн"],answer:1},
  {title:"Сколько ног-опор у башни?",options:["4","10","12"],answer:1},
  ...
  {title:"Что вращается примерно один раз за час?",options:["Антенна","Пол ресторана","Стеклянный пол площадки"],answer:1},
  {title:"Какую нагрузку выдерживает стеклянный пол?",options:["До трёх тонн","До 145 тонн","До 55 тысяч тонн"],answer:0},
  {title:"Какая цепочка верна?",options:["Шуховская башня — новая; Останкинская — прежняя","Шуховская — 160 м; Останкинская — 540 м","Обе башни имеют высоту 337 м"],answer:1},
...
const cards = [
  ["1967 год","Построена Останкинская телебашня"],["540 метров","Высота башни"],["Точная подпись","Телебашня"],["Николай Васильевич Никитин","Инженер и конструктор"],["Леонид Ильич Баталов","Архитектор"],["145 канатов","Сжимают бетон и защищают от трещин"],["Борис Давидович Тринкер","Сверхпрочный бетон"],["4,5 метра и 55 тысяч тонн","Глубина фундамента и вес башни"],["337 метров","Смотровая площадка и ресторан"],["7 метров в секунду","Скорость пассажирских лифтов"],
];

const workshopData: WorkshopData = {
  route:"Останкинская телебашня",image:"./assets/card-tower.png",imageAlt:"Останкинская телебашня",identifyPrompt:"Впиши точную подпись объекта.",identifyAnswer:"Телебашня",
  matchPrompt:"Выбери верное соответствие.",matchOptions:["Никитин — инженер; Баталов — архитектор; Тринкер — химик","Никитин — химик; Баталов — инженер; Тринкер — архитектор","Никитин — архитектор; Баталов — химик; Тринкер — инженер"],matchAnswer:0,
  events:[["shukhov","Шуховская башня обслуживает телевидение"],["build","1967 год — построена Останкинская телебашня"],["storm","1998 год — ураган, отклонение шпиля на 6 метров"],["today","Башня продолжает передавать сигналы"]],correctOrder:["shukhov","build","storm","today"],
  errorStatements:["Останкинскую телебашню построили в 1967 году.","Николай Никитин был архитектором, отвечавшим только за красоту башни.","Внутри башни натянуты 145 стальных канатов.","Смотровая площадка находится на высоте 540 метров."],errorIndexes:[1,3],
  anagramPrompt:"Составь слово из перемешанных букв.",anagramLetters:"Ш • Н • Я • Т • Е • Л • Е • Б • А",anagramAnswer:"телебашня",
  crossword:[["Толстый кабель, по которому сигнал идёт вверх","ФИДЕР"],["Нижняя подземная часть сооружения","ФУНДАМЕНТ"],["Создатель прочной конструкции башни","НИКИТИН"],["Район Москвы, давший башне название","ОСТАНКИНО"]],
};

const important = /(1967 году|1967 год|540 метров|160 метров|Владимиром Григорьевичем Шуховым|Николай Васильевич Никитин|Леонид Ильич Баталов|145 стальных канатов|10 000 тонн|Борисом Давидовичем Тринкером|5–6 метров|4,5 метра|55 тысяч тонн|десять ног-опор|12 метров|1998 года|6 метров|337 метров|трёх тонн|7 метров в секунду|20 метров в секунду|Телебашня|фидерам)/g;
const importantPart = /^(1967 году|1967 год|540 метров|160 метров|Владимиром Григорьевичем Шуховым|Николай Васильевич Никитин|Леонид Ильич Баталов|145 стальных канатов|10 000 тонн|Борисом Давидовичем Тринкером|5–6 метров|4,5 метра|55 тысяч тонн|десять ног-опор|12 метров|1998 года|6 метров|337 метров|трёх тонн|7 метров в секунду|20 метров в секунду|Телебашня|фидерам)$/;
const lessonMedia = [["tower-04.jpg","Общий вид башни"],["tower-05.jpg","Телевизионный сигнал внутри башни"],["tower-06.jpg","Шуховская и Останкинская башни"],["tower-10.jpg","Инженерная форма башни"],["tower-07.jpg","Канатная арматура"],["tower-08.jpg","Строительство башни"],["tower-09.jpg","Устройство и устойчивость"],["tower-09.jpg","Башня и ветер"],["tower-11.jpg","Смотровая площадка и ресторан"]] as const;
  ...
  return <main className="compact highrise-module route-start stars-module">
    ...
    {page === "plan" && <>
      ...
      <section className="route-cover">
        ...
        <div>
          ...
          <dl>
            ...
            <div className="architects"><dt>Источник школьного тура</dt><dd><strong>Юлия Егорова</strong>, книга <strong>«Останкинская телебашня»</strong></dd></div>
          </dl>
        </div>
      </section>
      ...
      <div className="part-list">
        {["Сигнал и первая башня", "Конструкция и строительство", "Устойчивость и жизнь внутри"].map((title, index) => <button className="part-row" key={title} onClick={() => startPart(index)}><span><b>Часть {index + 1}. {title}</b><small>3 учебных экрана → 5 заданий</small></span><span>Открыть →</span></button>)}
    ...
    {page === "lesson" && <>
      <div className="progress"><span>ОСТАНКИНСКАЯ ТЕЛЕБАШНЯ • ЧАСТЬ {part + 1} ИЗ 3 • ЭКРАН {step % 3 + 1} ИЗ 3</span><div><i style={{ width: `${(step + 1) / 9 * 100}%` }} /></div></div>
      <section className="spread"><aside><img src={`./assets/${lessonMedia[step][0]}`} alt={lessonMedia[step][1]} /><small>ИЛЛЮСТРАЦИЯ ИЗ КНИГИ МАРШРУТА</small><p><strong>{lessonMedia[step][1]}</strong></p><div className="part-tag">ЧАСТЬ {part + 1}<br /><b>{["Сигнал и предшественница", "Конструкция и стройка", "Устойчивость и высота"][part]}</b></div></aside><article><div className="chapter-label">УЧЕБНЫЙ ЭКРАН • СНАЧАЛА ПОЙМИ, ПОТОМ ПРОВЕРЬ</div><h1>{lessons[step].title}</h1><p className="lesson-text">{mark(lessons[step].text)}</p><div className="fact-strip"><b>Опорная запись</b><span>{mark(lessons[step].fact)}</span></div><div className="lesson-nav"><button className="secondary" disabled={step % 3 === 0} onClick={() => setStep(step - 1)}>← Назад</button>{step % 3 < 2 ? <button className="primary" onClick={() => setStep(step + 1)}>Следующий экран →</button> : <button className="primary" onClick={startMini}>Мини-тур: 5 заданий →</button>}</div></article></section>
    </>}
