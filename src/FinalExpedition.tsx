...
const tasks: Task[] = [
  ...
  {group:"Главные факты",route:"Московские высотки",prompt:"Что произошло 7 сентября 1947 года?",options:["Заложили восемь высотных зданий","Открыли ВДНХ","Запустили первый спутник"],answer:0},
  ...
  {group:"Главные факты",route:"ВДНХ",prompt:"Когда впервые открылась выставка?",options:["1 августа 1939 года","7 сентября 1947 года","4 октября 1957 года"],answer:0},
