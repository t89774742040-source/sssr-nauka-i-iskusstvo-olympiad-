...
const workshopData: WorkshopData = {
  ...
  anagramPrompt: "Собери название пути спутника вокруг планеты.", anagramLetters: "О • Р • Б • И • Т • А", anagramAnswer: "орбита",
...
export default function StarsRoute({ onBack, onMatching }: { onBack: () => void; onMatching: () => void }) {
